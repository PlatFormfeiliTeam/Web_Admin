        ...
        Ext.onReady(function () {
            ...
            var gridpanel = Ext.create('Ext.grid.Panel', {
                ...
                columns: [
                    ...
                    { header: '商品项数', dataIndex: 'COMMODITYNUM', width: 120 },
                    { header: '国检状态', dataIndex: 'INSPSTATUS', width: 80 },
                    { header: '删改单标志', dataIndex: 'MODIFYFLAG', width: 130 },
                    { header: '预制单编号', dataIndex: 'PREINSPCODE', width: 60 },
                    { header: '企业编号', dataIndex: 'CUSNO', width: 130 },
                    { header: '旧报检单号', dataIndex: 'OLDINSPECTIONCODE', width: 60 },
